...
#ifndef JEM_MP_MPI_REQUESTLIST_H
#define JEM_MP_MPI_REQUESTLIST_H
...
class RequestList : public mp::RequestList
{
 ...
 private:
  ...
  util::Flex<MPI_Request>   reqs_;
  util::Flex<MPI_Datatype>  types_;
  util::Flex<MPI_Status>    stats_;
  util::Flex<idx_t>         iperm_;
  util::Flex<idx_t>         jperm_;
  util::Flex<int>           itemp_;
