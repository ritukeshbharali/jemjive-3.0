...
#ifndef JEM_BASE_NATIVE_WINPROCESS_H
#define JEM_BASE_NATIVE_WINPROCESS_H

#include <jem/base/Process.h>


#undef  JEM_DEV_NULL
#define JEM_DEV_NULL "NUL"
...
class WinProcess : public Process
{
 public:
  ...
  JEM_DECLARE_CLASS       ( WinProcess, Process );
...
typedef WinProcess          NativeProcess;
