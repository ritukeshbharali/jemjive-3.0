...
template <class T, class U>
  ...
  class SetImag<T,U,Nil> : public BinaryFunc
    < std::complex<T>, U,
      typename CombineTraits<T,U>::ResultType >

{
 public:
  ...
  {
    return typename
      CombineTraits<T,U>::ResultType ( z.real(), im );
  }
...
template <class T, class U>
  ...
  class SetReal<T,U,Nil> : public BinaryFunc
    < std::complex<T>, U,
      typename CombineTraits<T,U>::ResultType >

{
 public:
  ...
  {
    return typename
      CombineTraits<T,U>::ResultType ( re, z.imag() ) ;
  }
