...
#ifndef JEM_IO_CRCOUTPUTSTREAM_H
#define JEM_IO_CRCOUTPUTSTREAM_H
...
class CRCOutputStream : public FilterOutputStream
{
 public:

  typedef CRCOutputStream   Self;
  typedef
    FilterOutputStream      Super;


  explicit                  CRCOutputStream
