...
#ifndef JEM_MT_THREADSAFEOUTPUTSTREAM_H
#define JEM_MT_THREADSAFEOUTPUTSTREAM_H
...
class ThreadSafeOutputStream : public OutputStream
{
 public:
  ...
  typedef
    ThreadSafeOutputStream  Self;
  typedef OutputStream      Super;


  explicit                  ThreadSafeOutputStream
 ...
 protected:
                            ...
                            ThreadSafeOutputStream ();
  virtual                  ~ThreadSafeOutputStream ();
