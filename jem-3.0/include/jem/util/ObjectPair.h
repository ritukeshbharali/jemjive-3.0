...
#ifndef JEM_UTIL_OBJECTPAIR_H
#define JEM_UTIL_OBJECTPAIR_H
                   ...
                   public io::Serializable
{
 public:
  ...
  JEM_DECLARE_CLASS     ( ObjectPair, Object );
  ...
  virtual Ref<Object>     getFirst    () const;
  virtual Ref<Object>     getSecond   () const;
