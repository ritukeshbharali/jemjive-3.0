...
#ifndef JEM_BASE_CHARACTER_H
#define JEM_BASE_CHARACTER_H
                  ...
                  public io::Serializable
{
 public:
  ...
  JEM_DECLARE_CLASS     ( Character, Object );
...
inline Character::Character ( char val ) : value ( val )
{}


//=======================================================================
//   class DynRefCaster<Character,Object>
//=======================================================================
...

{
 public:
...

  {
    ...
    {
      return Character::dynamicCast ( *rhs );
    }
    else
    {
