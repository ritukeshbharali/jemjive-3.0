...
class LinearPalette : public Palette
{
 public:
  ...
  inline Color              getMinColor   () const noexcept;
  inline Color              getMaxColor   () const noexcept;
...
inline Color LinearPalette::getMinColor () const noexcept
{
  return minColor_;
}


inline Color LinearPalette::getMaxColor () const noexcept
{
  return maxColor_;
}
