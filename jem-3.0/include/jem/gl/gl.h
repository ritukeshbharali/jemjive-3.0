...
// Note that this header file is a modified version of the header
// file "glew_head.h" that is part of version 2.1.0 of the GLEW
// library. The license applicable to that version of the
// "glew_head.h" header file therefore also applies to this
// header file.

#if defined(__gl_h_) || defined(__GL_H__) || \
    defined(_GL_H)   || defined(__X_GL_H)
#  error <gl.h> included before <jem/gl/gl.h>
#endif
#if defined(__gl2_h_)
#  error <gl2.h> included before <jem/gl/gl.h>
#endif
#if defined(__gltypes_h_)
#  error <gltypes.h> included before <jem/gl/gl.h>
#endif
#if defined(__REGAL_H__)
#  error <Regal.h> included before <jem/gl/gl.h>
#endif
#if defined(__glext_h_) || defined(__GLEXT_H_)
#  error <glext.h> included before <jem/gl/gl.h>
#endif
#if defined(__gl_ATI_h_)
#  error <glATI.h> included before <jem/gl/gl.h>
#endif
...
// Do not include <windows.h> to avoid name space pollution.
// GL needs GLAPI and GLAPIENTRY, GLU needs APIENTRY, CALLBACK,
// and wchar_t defined properly.
...
#  ifndef CALLBACK
#    define JEM_UNDEF_CALLBACK
#    if defined(__MINGW32__) || defined(__CYGWIN__)
#      define CALLBACK __attribute__ ((__stdcall__))
#    elif (defined(_M_MRX000) || defined(_M_IX86) || \
...
#  if ! defined(_PTRDIFF_T_DEFINED) && \
       ! defined(_PTRDIFF_T_) && !defined(__MINGW64__)
#    ifdef _WIN64
...
#define JEM_APIENTRYP JEM_APIENTRY *

#ifndef APIENTRY
#  define APIENTRY JEM_APIENTRY
#  define JEM_UNDEF_APIENTRY
#endif

#ifndef GLAPIENTRY
#  define GLAPIENTRY JEM_APIENTRY
#endif
...
#if defined(JEM_UNDEF_APIENTRY)
#  undef APIENTRY
#  undef JEM_UNDEF_APIENTRY
#endif

#if defined(JEM_UNDEF_WINGDIAPI)
#  undef WINGDIAPI
#  undef JEM_UNDEF_WINGDIAPI
#endif

#if defined(JEM_UNDEF_CALLBACK)
#  undef CALLBACK
#  undef JEM_UNDEF_CALLBACK
#endif
