...
#ifndef JEM_NUMERIC_FUNC_CONSTANTFUNC_H
#define JEM_NUMERIC_FUNC_CONSTANTFUNC_H
...
class ConstantFunc : public Function,
                     public Serializable
{
 public:

  JEM_DECLARE_CLASS       ( ConstantFunc, Function );


  explicit inline           ConstantFunc
...
inline ConstantFunc::ConstantFunc ( double val ) noexcept :
