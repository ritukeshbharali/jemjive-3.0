...
#ifndef JIVE_APP_PRIVATE_LOGWRITER_H
#define JIVE_APP_PRIVATE_LOGWRITER_H
...
class LogWriter : public PrefixWriter
{
 public:

  typedef LogWriter         Self;
  typedef PrefixWriter      Super;
