...
JEM_DEFINE_CLASS( jive::graph::DummyOptimizer );
...
const char*  DummyOptimizer::TYPE_NAME = "None";
...
DummyOptimizer::DummyOptimizer ( const String& name ) :
...
Ref<Optimizer> DummyOptimizer::makeNew
