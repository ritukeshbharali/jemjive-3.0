...
//=======================================================================
//   class OptimizerFactory::CtorMap_
//=======================================================================
...
bool OptimizerFactory::exists ( const String& type )
{
...
StringVector OptimizerFactory::listKnownTypes ()
{
...
Ref<Optimizer> OptimizerFactory::newInstance
...
{
  Properties      subConf  = props.makeProps ( name );
  ...
  opter = newInstance ( type, name, conf, props, globdat );
