...
//=======================================================================
//   class GeometryFactory::CtorMap_
//=======================================================================


class GeometryFactory::CtorMap_ : public util::CtorMap<Constructor>
{};
...
bool GeometryFactory::exists ( const String& type )
{
...
StringVector GeometryFactory::listKnownTypes ()
{
...
Ref<Geometry> GeometryFactory::newInstance
...

{
  ...
  geom = newInstance ( type, name, conf, props, globdat );
