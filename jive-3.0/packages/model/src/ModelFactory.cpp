...
//=======================================================================
//   class ModelFactory::CtorMap_
//=======================================================================


class ModelFactory::CtorMap_ : public util::CtorMap<Constructor>
{};
...
bool ModelFactory::exists ( const String& type )
{
...
StringVector ModelFactory::listKnownTypes ()
{
...
Ref<Model> ModelFactory::newInstance
...

{
  ...
  model = newInstance ( type, name, conf, props, globdat );
