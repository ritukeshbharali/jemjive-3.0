...
//=======================================================================
//   class TimeStepperFactory::CtorMap_
//=======================================================================
...
void TimeStepperFactory::declare
...
bool TimeStepperFactory::exists ( const String& type )
{
...
StringVector TimeStepperFactory::listKnownTypes ()
{
...
Ref<TimeStepper> TimeStepperFactory::newInstance
...

{
  ...
  Ref<TimeStepper>  stepper =
    ...
    newInstance ( type, name, conf, props, globdat );
