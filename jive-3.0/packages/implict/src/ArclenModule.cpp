...
JEM_DEFINE_CLASS( jive::implict::ArclenModule );
...
//=======================================================================
//   class ArclenModule::RunData_
//=======================================================================


class ArclenModule::RunData_ : public NonlinRunData
{
 public:
...
inline ArclenModule::RunData_::RunData_ ( const String& ctx ) :
...
void ArclenModule::RunData_::initArcModel
...
bool ArclenModule::RunData_::commit ( const Properties& globdat )
{
...
void ArclenModule::RunData_::cancel ( const Properties& globdat )
{
  using jive::util::Globdat;
...
//=======================================================================
//   class ArclenModule::Work_
//=======================================================================


class ArclenModule::Work_ : public ConHandler
{
 public:
...
inline ArclenModule::Work_::~Work_ ()
{
  rundat.frozen    = false;
...
void ArclenModule::Work_::updateState ()
{
  double  alpha, b, c;
...
void ArclenModule::Work_::updateRscale
...
void ArclenModule::Work_::updateResidual ()
{
  r = -fint;
...
inline void ArclenModule::Work_::updateModel
...
void ArclenModule::Work_::updateUnitLoad
...
void ArclenModule::Work_::updateArcFunc
...
bool ArclenModule::Work_::checkConverged
...
void ArclenModule::Work_::reportProgress ()
{
...
const char*  ArclenModule::TYPE_NAME  = "Arclen";
...
ArclenModule::ArclenModule ( const String& name ) :
...
Module::Status ArclenModule::init
...
void ArclenModule::shutdown ( const Properties& globdat )
{
  rundat_ = nullptr;
}
...
void ArclenModule::advance ( const Properties& globdat )
{
  if ( ! rundat_ )
  {
...

{
  ...
  print ( System::info( myName_ ),
          "Starting the generalized arc-length solver `",
          myName_, "\' ...\n" );
...
void ArclenModule::cancel ( const Properties& globdat )
{
  if ( ! rundat_ )
  {
    notAliveError ( JEM_FUNC );
...
bool ArclenModule::commit ( const Properties& globdat )
{
  if ( ! rundat_ )
  {
    notAliveError ( JEM_FUNC );
...
void ArclenModule::setPrecision ( double eps )
{
...
double ArclenModule::getPrecision () const
{
  return precision_;
}
...
void ArclenModule::setOptions ( Options options )
{
  options_ = options;
}
...
ArclenModule::Options ArclenModule::getOptions () const
{
  return options_;
}
...
void ArclenModule::setLoadScale ( double scale )
{
  if ( ! rundat_ )
  {
    loadScale_ = scale;
...
double ArclenModule::getLoadScale () const
{
  if ( ! rundat_ )
  {
    return loadScale_;
...
Ref<Module> ArclenModule::makeNew
