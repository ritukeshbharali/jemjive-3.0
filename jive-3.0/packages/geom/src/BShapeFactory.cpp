...
//=======================================================================
//   class BShapeFactory::CtorMap_
//=======================================================================


class BShapeFactory::CtorMap_ : public CtorMap<Constructor>
{};
...
bool BShapeFactory::exists ( const String& type )
{
...
StringVector BShapeFactory::listKnownTypes ()
{
...
Ref<BShape> BShapeFactory::newInstance
