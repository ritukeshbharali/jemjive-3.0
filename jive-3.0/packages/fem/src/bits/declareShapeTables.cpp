...
static void declareShapeTables_ ()
{
  AutoShapeTable   :: declare ();
  AutoShapeTable1D :: declare ();
  AutoShapeTable2D :: declare ();
  AutoShapeTable3D :: declare ();
  CustomShapeTable :: declare ();
}
...
void declareShapeTables ()
{
  ...
  jem::runOnce ( once, declareShapeTables_ );
}
