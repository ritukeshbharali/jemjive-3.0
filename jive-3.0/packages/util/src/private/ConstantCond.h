...
#ifndef JIVE_UTIL_PRIVATE_CONSTANTCOND_H
#define JIVE_UTIL_PRIVATE_CONSTANTCOND_H
...
class ConstantCond : public Function,
                     public Serializable
{
 public:

  JEM_DECLARE_CLASS       ( ConstantCond, Function );


  explicit inline           ConstantCond
...
inline ConstantCond::ConstantCond ( bool val ) : value ( val )
{}
