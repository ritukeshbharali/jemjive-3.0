...
#ifndef JIVE_UTIL_PRIVATE_TEMPDATA_H
#define JIVE_UTIL_PRIVATE_TEMPDATA_H
...
class TempData : public HashDictionary
{
 public:

  JEM_DECLARE_CLASS       ( TempData, HashDictionary );
