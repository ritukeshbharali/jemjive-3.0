...
static void declareConstrainers_ ()
{
  DummyConstrainer   :: declare ();
  StdConstrainer     :: declare ();
  PointConstrainer   :: declare ();
  GenericConstrainer :: declare ();
}
...
void declareConstrainers ()
{
  ...
  jem::runOnce ( once, declareConstrainers_ );
}
