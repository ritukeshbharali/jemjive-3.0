...
//=======================================================================
//   class EigenSolverFactory::CtorMap_
//=======================================================================
...
void EigenSolverFactory::declare
...
bool EigenSolverFactory::exists ( const String& type )
{
...
StringVector EigenSolverFactory::listKnownTypes ()
{
...
Ref<EigenSolver> EigenSolverFactory::newInstance
...

{
  ...
  if ( ctor )
  {
    return ctor ( name, conf, props, params );
  }
  else
  {
    return nullptr;
...

{
  ...
  solver = newInstance ( type, name, conf, props, params );
  ...
  if ( ! solver )
  {
    if ( CtorMap_::contains( type ) )
    {
      ...
      subProps.propertyError (
        TYPE_PROP,
        String::format (
          "invalid eigensolver: `%s\' "
          "(wrong matrix type or invalid parameters)",
          type
        )
      );
    }
