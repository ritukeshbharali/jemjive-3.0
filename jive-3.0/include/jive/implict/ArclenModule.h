...
#ifndef JIVE_IMPLICT_ARCLENMODULE_H
#define JIVE_IMPLICT_ARCLENMODULE_H
...
class ArclenModule : public SolverModule
{
 public:

  JEM_DECLARE_CLASS       ( ArclenModule, SolverModule );
...
JEM_DEFINE_FLAG_OPS( ArclenModule::Options )
