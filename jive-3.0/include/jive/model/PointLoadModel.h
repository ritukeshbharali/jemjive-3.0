...
#ifndef JIVE_MODEL_POINTLOADMODEL_H
#define JIVE_MODEL_POINTLOADMODEL_H
...
class PointLoadModel : public Model,
                       public Serializable
{
 public:

  JEM_DECLARE_CLASS       ( PointLoadModel, Model );

  static const char*        TYPE_NAME;


  explicit                  PointLoadModel
