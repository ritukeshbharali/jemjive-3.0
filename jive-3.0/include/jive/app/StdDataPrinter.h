...
#ifndef JIVE_APP_STDDATAPRINTER_H
#define JIVE_APP_STDDATAPRINTER_H
...
class StdDataPrinter : public DataPrinter
{
 public:

  JEM_DECLARE_CLASS       ( StdDataPrinter, DataPrinter );


  explicit                  StdDataPrinter
