...
#ifndef JIVE_APP_CHECKPOINTMODULE_H
#define JIVE_APP_CHECKPOINTMODULE_H
...
class CheckpointModule : public Module
{
 public:
  ...
  JEM_DECLARE_CLASS       ( CheckpointModule, Module );
