...
#ifndef JIVE_APP_SAMPLEMODULE_H
#define JIVE_APP_SAMPLEMODULE_H
...
class SampleModule : public Module
{
 public:
  ...
  JEM_DECLARE_CLASS       ( SampleModule, Module );
...
JEM_DEFINE_FLAG_OPS( SampleModule::Options )
