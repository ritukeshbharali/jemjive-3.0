...
#ifndef JIVE_ALGEBRA_MIXEDGRAMSCHMIDT_H
#define JIVE_ALGEBRA_MIXEDGRAMSCHMIDT_H
...
class MixedGramSchmidt : public GramSchmidt
{
 public:

  JEM_DECLARE_CLASS       ( MixedGramSchmidt, GramSchmidt );
