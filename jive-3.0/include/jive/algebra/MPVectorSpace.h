...
#ifndef JIVE_ALGEBRA_MPVECTORSPACE_H
#define JIVE_ALGEBRA_MPVECTORSPACE_H
...
class MPVectorSpace : public VectorSpace,
                      public Clonable,
                      public Serializable
{
 public:

  JEM_DECLARE_CLASS       ( MPVectorSpace, VectorSpace );
    ...
    ( const Ref<Super>&       inner,
      ...
      const Ref<ItemMask>&    mask = nullptr );
  ...
  inline VectorSpace*       getInner        () const;
  inline ItemMask*          getItemMask     () const;
...
inline VectorSpace* MPVectorSpace::getInner () const
{
  return vspace_.get ();
}
...
inline ItemMask* MPVectorSpace::getItemMask () const
{
  return mask_.get ();
}
