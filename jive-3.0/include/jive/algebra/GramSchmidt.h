...
#ifndef JIVE_ALGEBRA_GRAMSCHMIDT_H
#define JIVE_ALGEBRA_GRAMSCHMIDT_H
...
class GramSchmidt : public NamedObject
{
 public:

  JEM_DECLARE_CLASS       ( GramSchmidt, NamedObject );


  explicit                  GramSchmidt
