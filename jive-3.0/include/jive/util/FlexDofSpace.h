...
#ifndef JIVE_UTIL_FLEXDOFSPACE_H
#define JIVE_UTIL_FLEXDOFSPACE_H
...
class FlexDofSpace : public XDofSpace,
                     public Clonable,
                     public Serializable
{
 public:

  JEM_DECLARE_CLASS       ( FlexDofSpace, XDofSpace );


                            FlexDofSpace   ();

  explicit                  FlexDofSpace
 ...
 private:
  ...
  Ref<XDofSpace>            dofs_;
  Ref<DenseDofSpace>        dense_;
  Ref<SparseDofSpace>       sparse_;
