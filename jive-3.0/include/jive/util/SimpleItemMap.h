...
#ifndef JIVE_UTIL_SIMPLEITEMMAP_H
#define JIVE_UTIL_SIMPLEITEMMAP_H
...
class SimpleItemMap : public XItemMap,
                      public Clonable,
                      public Serializable
{
 public:

  JEM_DECLARE_CLASS     ( SimpleItemMap, XItemMap );
