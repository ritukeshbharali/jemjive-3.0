...
#ifndef JIVE_UTIL_DBASEPARSER_H
#define JIVE_UTIL_DBASEPARSER_H
...
class DBaseParser : public jem::xml::Parser
{
 public:

  JEM_DECLARE_CLASS       ( DBaseParser, jem::xml::Parser );

  static const char*        NO_NEW_COLUMNS;


  explicit                  DBaseParser

    ( const Ref<MPContext>&   mpx       = nullptr,
      const Ref<Database>&    dbase     = nullptr,
