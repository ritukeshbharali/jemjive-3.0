...
#ifndef JIVE_UTIL_TABLEPARSER_H
#define JIVE_UTIL_TABLEPARSER_H
...
class TableParser : public jem::xml::Parser
{
 public:

  JEM_DECLARE_CLASS       ( TableParser, jem::xml::Parser );

  static const char*        NO_NEW_COLUMNS;


  explicit                  TableParser

    ( const Ref<MPContext>&   mpx       = nullptr,
      const Ref<XTable>&      table     = nullptr,
