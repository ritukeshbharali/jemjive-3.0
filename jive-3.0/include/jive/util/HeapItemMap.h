...
#ifndef JIVE_UTIL_HEAPITEMMAP_H
#define JIVE_UTIL_HEAPITEMMAP_H
...
class HeapItemMap : public XItemMap,
                    public Clonable,
                    public Serializable
{
 public:

  JEM_DECLARE_CLASS     ( HeapItemMap, XItemMap );
