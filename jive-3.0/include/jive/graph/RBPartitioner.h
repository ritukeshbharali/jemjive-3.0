...
#ifndef JIVE_GRAPH_RBPARTITIONER_H
#define JIVE_GRAPH_RBPARTITIONER_H
...
class RBPartitioner : public Partitioner
{
 public:

  JEM_DECLARE_CLASS         ( RBPartitioner, Partitioner );

  static const char*          TYPE_NAME;


  explicit                    RBPartitioner
