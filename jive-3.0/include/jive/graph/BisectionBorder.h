...
#ifndef JIVE_GRAPH_BISECTIONBORDER_H
#define JIVE_GRAPH_BISECTIONBORDER_H
...
inline idx_t BisectionBorder::size () const
{
  return bnodeCount_;
}
...
inline idx_t BisectionBorder::cutWeight () const
{
  return cutWeight_;
}
...
inline Partition* BisectionBorder::getPartition () const
{
...
inline void BisectionBorder::getNode
...
inline void BisectionBorder::remapNode
