...
#ifndef JIVE_GEOM_TRIANGLE_H
#define JIVE_GEOM_TRIANGLE_H
...
class Triangle
{
 public:
  ...
  static const int        BOUNDARY_COUNT = 3;
...
typedef Triangle3         LinearTriangle;
typedef Triangle6         QuadraticTriangle;
