...
#ifndef JIVE_GEOM_STDHYPERCUBE_H
#define JIVE_GEOM_STDHYPERCUBE_H
...
class StdHyperCube : public StdShape
{
 public:

  typedef StdHyperCube    Self;
 ...
 protected:
  ...
  virtual                ~StdHyperCube   ();


 private:

  static idx_t            quarticRoot_
...
class StdHyperCube16 : public StdHyperCube,
                       public Serializable
{
 public:

  JEM_DECLARE_CLASS     ( StdHyperCube16, StdHyperCube );
