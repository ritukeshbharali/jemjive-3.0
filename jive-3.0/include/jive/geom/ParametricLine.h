...
#ifndef JIVE_GEOM_PARAMETRICLINE_H
#define JIVE_GEOM_PARAMETRICLINE_H
...
class ParametricLine : public ParametricShape
{
 public:

  JEM_DECLARE_CLASS       ( ParametricLine, ParametricShape );
