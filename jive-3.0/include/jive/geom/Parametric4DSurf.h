...
#ifndef JIVE_GEOM_PARAMETRIC4DSURF_H
#define JIVE_GEOM_PARAMETRIC4DSURF_H
...
class Parametric4DSurf : public ParametricBoundary
{
 public:

  JEM_DECLARE_CLASS       ( Parametric4DSurf,
                            ParametricBoundary );
