...
#ifndef JIVE_GEOM_PARAMETRICAREA_H
#define JIVE_GEOM_PARAMETRICAREA_H
...
class ParametricArea : public ParametricShape
{
 public:

  JEM_DECLARE_CLASS       ( ParametricArea, ParametricShape );
