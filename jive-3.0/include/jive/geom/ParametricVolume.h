...
#ifndef JIVE_GEOM_PARAMETRICVOLUME_H
#define JIVE_GEOM_PARAMETRICVOLUME_H
...
class ParametricVolume : public ParametricShape
{
 public:

  JEM_DECLARE_CLASS       ( ParametricVolume, ParametricShape );
