...
#ifndef JIVE_FEM_BOUNDARYELEMENT_H
#define JIVE_FEM_BOUNDARYELEMENT_H
...
class BoundaryElement : public Element
{
 public:
  ...
  JEM_DECLARE_CLASS       ( BoundaryElement, Element );

  typedef geom::BShape      BShape;


  explicit                  BoundaryElement

    ( const ElementSet&       elems,
      const Ref<BShape>&      shape = nullptr );
