...
#ifndef JIVE_FEM_BOUNDARYITERATOR_H
#define JIVE_FEM_BOUNDARYITERATOR_H
...
class BoundaryIterator : public FEIterator,
                         public Serializable
{
 public:

  JEM_DECLARE_CLASS       ( BoundaryIterator, FEIterator );
...
inline BoundarySet BoundaryIterator::getBoundaries () const
{
...
inline ElementSet BoundaryIterator::getElements () const
{
...
inline NodeSet BoundaryIterator::getNodes () const
{
