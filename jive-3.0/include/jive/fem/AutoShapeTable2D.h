...
#ifndef JIVE_FEM_AUTOSHAPETABLE2D_H
#define JIVE_FEM_AUTOSHAPETABLE2D_H
...
class AutoShapeTable2D : public AutoShapeTable
{
 public:

  JEM_DECLARE_CLASS       ( AutoShapeTable2D, AutoShapeTable );
  ...
  static void               initTriangProps

    ( const Properties&       props,
      idx_t                   prec,
      idx_t                   nodeCount );

  static void               initQuadProps

    ( const Properties&       props,
      idx_t                   prec,
      idx_t                   nodeCount );

  static void               initBLineProps
