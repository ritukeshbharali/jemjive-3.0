...
#ifndef JIVE_FEM_AUTOSHAPETABLE1D_H
#define JIVE_FEM_AUTOSHAPETABLE1D_H
...
class AutoShapeTable1D : public AutoShapeTable
{
 public:

  JEM_DECLARE_CLASS       ( AutoShapeTable1D, AutoShapeTable );
