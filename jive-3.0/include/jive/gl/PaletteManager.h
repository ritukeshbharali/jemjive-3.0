...
#ifndef JIVE_GL_PALETTEMANAGER_H
#define JIVE_GL_PALETTEMANAGER_H
...
class PaletteManager : public Plugin
{
 public:

  JEM_DECLARE_CLASS       ( PaletteManager, Plugin );


  explicit                  PaletteManager
