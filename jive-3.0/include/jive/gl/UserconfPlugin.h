...
#ifndef JIVE_GL_USERCONFPLUGIN_H
#define JIVE_GL_USERCONFPLUGIN_H
...
class UserconfPlugin : public Plugin
{
 public:

  JEM_DECLARE_CLASS       ( UserconfPlugin, Plugin );

  static const char*        TYPE_NAME;


  explicit                  UserconfPlugin
 ...
 protected:
  ...
  virtual                  ~UserconfPlugin  ();


 private:

  Ref<Plugin>               newPlugin_
