...
#ifndef JIVE_GL_NODEDOFSVIEW_H
#define JIVE_GL_NODEDOFSVIEW_H
...
class NodeDofsView : public Plugin
{
 public:

  JEM_DECLARE_CLASS       ( NodeDofsView, Plugin );

  static const char*        TYPE_NAME;


  explicit                  NodeDofsView
