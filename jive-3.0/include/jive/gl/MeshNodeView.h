...
#ifndef JIVE_GL_MESHNODEVIEW_H
#define JIVE_GL_MESHNODEVIEW_H
...
class MeshNodeView : public Plugin
{
 public:

  JEM_DECLARE_CLASS       ( MeshNodeView, Plugin );

  static const char*        TYPE_NAME;


  explicit                  MeshNodeView
