...
#ifndef JIVE_GL_ELEMGROUPVIEW_H
#define JIVE_GL_ELEMGROUPVIEW_H
...
class ElemGroupView : public Plugin
{
 public:

  JEM_DECLARE_CLASS       ( ElemGroupView, Plugin );

  static const char*        TYPE_NAME;


  explicit                  ElemGroupView
