...
#ifndef JIVE_SOLVER_NULLSPACERESTRICTOR_H
#define JIVE_SOLVER_NULLSPACERESTRICTOR_H
...
class NullSpaceRestrictor : public DenseRestrictor
{
 public:

  JEM_DECLARE_CLASS       ( NullSpaceRestrictor, DenseRestrictor );
