...
#ifndef JIVE_SOLVER_DUMMYCONSTRAINER_H
#define JIVE_SOLVER_DUMMYCONSTRAINER_H
...
class DummyConstrainer : public Constrainer
{
 public:

  JEM_DECLARE_CLASS       ( DummyConstrainer, Constrainer );

  static const char*        TYPE_NAME;


  explicit                  DummyConstrainer
