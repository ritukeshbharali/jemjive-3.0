...
#ifndef JIVE_SOLVER_SOLVERPRECON_H
#define JIVE_SOLVER_SOLVERPRECON_H
...
class SolverPrecon : public Preconditioner
{
 public:

  JEM_DECLARE_CLASS       ( SolverPrecon, Preconditioner );
