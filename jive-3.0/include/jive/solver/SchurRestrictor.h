...
#ifndef JIVE_SOLVER_SCHURRESTRICTOR_H
#define JIVE_SOLVER_SCHURRESTRICTOR_H
...
class SchurRestrictor : public DenseRestrictor
{
 public:

  JEM_DECLARE_CLASS       ( SchurRestrictor, DenseRestrictor );
