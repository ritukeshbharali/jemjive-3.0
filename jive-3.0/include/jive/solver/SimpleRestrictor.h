...
#ifndef JIVE_SOLVER_SIMPLERESTRICTOR_H
#define JIVE_SOLVER_SIMPLERESTRICTOR_H
...
class SimpleRestrictor : public SparseRestrictor
{
 public:

  JEM_DECLARE_CLASS       ( SimpleRestrictor, SparseRestrictor );
  ...
  static const idx_t        MIN_NODES;
    ...
    ( const String&           name,
      ...
      Ref<AbstractMatrix>     matrix = nullptr,
