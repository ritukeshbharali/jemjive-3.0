...
#ifndef JIVE_SOLVER_GCR_H
#define JIVE_SOLVER_GCR_H
...
class GCR : public StdIterativeSolver
{
 public:

  JEM_DECLARE_CLASS       ( GCR, StdIterativeSolver );
 ...
 protected:
  ...
  virtual void              updatePrecon_   ()       override;
