...
#ifndef JIVE_SOLVER_MULTIRESTRICTOR_H
#define JIVE_SOLVER_MULTIRESTRICTOR_H
...
class MultiRestrictor : public  Restrictor,
                        private SparseMatrixExt,
                        private LocalRestrictor
{
 public:

  JEM_DECLARE_CLASS       ( MultiRestrictor, Restrictor );

  static const char*        TYPE_NAME;


  explicit                  MultiRestrictor
